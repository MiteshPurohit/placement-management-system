...
<body>
    ...
    <ul id="nav-mobile" class="side-nav fixed" style="height: 100%; width: 24%; transform: translateX(0px); border-right: solid thin #e0e0e0; transform: translateX(0px); margin: 0px 0px 0px 0px; padding-top: 5.35%;">
        ...
        <li class="bold active"><a href="view_student.aspx" style="padding-left: 48px;" class="waves-effect waves-teal">View & Edit Students Data</a></li>
    ...
    <div style="margin-top: 6%; width: 100%; padding: 0px; position: absolute; padding-left: 24%;">
        ...
        <div class="container" style="margin-top: 1%; margin-left: 0%;">
            <form runat="server">
                ...
                <asp:GridView CssClass="bordered highlight" ID="GridView2" runat="server" style="min-width:1500px;" AutoGenerateColumns="False" DataKeyNames="student_id" DataSourceID="student_data" AllowPaging="True" AllowSorting="True">
                    <Columns>
                        <asp:CommandField ShowEditButton="True" ShowDeleteButton="True"></asp:CommandField>
                        <asp:BoundField DataField="student_id" HeaderText="student id" ReadOnly="True" InsertVisible="False" SortExpression="student_id"></asp:BoundField>
                ...
                <asp:SqlDataSource runat="server" ID="student_data" ConnectionString='<%$ ConnectionStrings:pmsdbConnectionString %>' DeleteCommand="DELETE FROM [student_table] WHERE [student_id] = @student_id" InsertCommand="INSERT INTO [student_table] ([collage_id], [email_id], [password], [mobile_no], [branch], [dob], [cpi], [full_name], [achievement], [skills]) VALUES (@collage_id, @email_id, @password, @mobile_no, @branch, @dob, @cpi, @full_name, @achievement, @skills)" SelectCommand="SELECT [student_id], [collage_id], [email_id], [password], [mobile_no], [branch], [dob], [cpi], [full_name], [achievement], [skills] FROM [student_table]" UpdateCommand="UPDATE [student_table] SET [collage_id] = @collage_id, [email_id] = @email_id, [password] = @password, [mobile_no] = @mobile_no, [branch] = @branch, [dob] = @dob, [cpi] = @cpi, [full_name] = @full_name, [achievement] = @achievement, [skills] = @skills WHERE [student_id] = @student_id">
                    <DeleteParameters>
